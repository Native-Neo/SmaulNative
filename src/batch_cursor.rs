#[derive(Clone, Debug)]
pub struct BatchCursor { position: usize, total: usize }
impl BatchCursor {
...
#[cfg(test)]
mod tests{use super::*;#[test]fn bounded(){let mut c=BatchCursor::new(10);c.advance(7);assert_eq!(c.position(),7);c.advance(7);assert!(c.finished());assert_eq!(c.remaining(),0);}}
