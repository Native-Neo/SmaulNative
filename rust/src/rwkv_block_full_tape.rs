...
pub struct RwkvBlockFullTape {
    ...
    pub ln0_input: Option<Array2<f32>>,
    pub ln0_output: Option<Array2<f32>>,
    pub ln1_input: Array2<f32>,
    pub ln1_output: Array2<f32>,
    pub time: RwkvTimeMixTape,
    pub residual: Array2<f32>,
    pub ln2_input: Array2<f32>,
    pub ln2_output: Array2<f32>,
    pub cmix_input: Array2<f32>,
    pub cmix_prev: Array1<f32>,
    pub cmix_mixed: Array2<f32>,
    pub cmix_pre: Array2<f32>,
    pub cmix_hidden: Array2<f32>,
    pub cmix_output: Array2<f32>,
    pub output: Array2<f32>,
    pub initial_state: Option<RwkvBlockState>,
    pub next_state: RwkvBlockState,
}

impl RwkvBlockFullTape {
    pub fn new(
        input: Array2<f32>,
        time: RwkvTimeMixTape,
        next_state: RwkvBlockState,
    ) -> Self {
        ...
        Self {
            ...
            cmix_pre: Array2::zeros((shape.0, channels * 4)),
            cmix_hidden: Array2::zeros((shape.0, channels * 4)),
